...
class Preview(Config):
    ...
    CONTACT_LIST_UPLOAD_BUCKET_NAME = get_env_var('CONTACT_LIST_UPLOAD_BUCKET_NAME', 'preview-contact-list')
    LOGO_UPLOAD_BUCKET_NAME = get_env_var('LOGO_UPLOAD_BUCKET_NAME', 'public-logos-preview')
...
class Staging(Config):
    ...
    ASSET_PATH = get_env_var('ASSET_PATH', 'https://static.staging-notify.works/')
...
class Live(Config):
    ...
    ASSET_PATH = get_env_var('ASSET_PATH', 'https://static.notifications.service.gov.uk/')
...
class Sandbox(CloudFoundryConfig):
    ...
    LOGO_UPLOAD_BUCKET_NAME = get_env_var('LOGO_UPLOAD_BUCKET_NAME', 'cf-sandbox-notifications-logo-upload')
